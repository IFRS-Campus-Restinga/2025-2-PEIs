...
def populaPeiCentral():
    ...
    for item in peis:
        try:
            ...
            print(f"PeiCentral inserido com sucesso!\n{item}")
        except Exception as e:
            print(f"Erro ao inserir PeiCentral. Causa: {e}")


# ------------------------------------------
# popular model aluno com dados
...
def populaAluno():
    ...
    alunos = [
        ...
        "matricula": "2021011234",
        "email": "2021011234@aluno.restinga.ifrs.edu.br",
        },
        {
        "nome": "Mariazinha Silveira",
        "matricula": "2022024321",
        "email": "2022024321@aluno.restinga.ifrs.edu.br",
        },
        {
        "nome": "José da Silva Silvano",
        "matricula": "2023034444",
        "email": "2023034444@aluno.restinga.ifrs.edu.br",
        },
    ]
    # agora insere as entradas no banco
    for item in alunos:
        try:
            Aluno.objects.create(**item)
            print(f"Aluno {item} inserido com sucesso!")
        except Exception as e:
            print(f"Erro ao inserir aluno {item}. Causa: {e}")
