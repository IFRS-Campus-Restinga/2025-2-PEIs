  ...
  return (
    <nav className="subheader">
      <div className="subheader-buttons">
        ...
        <button onClick={() => navigate("/periodo")} className="subheader-btn">Visualizar PEI de Períodos Letivos</button>
        ...
        <button onClick={() => navigate("/pedagogo")} className="subheader-btn">Cadastrar Pedagogo</button>
      </div>
    </nav>
  );
};
