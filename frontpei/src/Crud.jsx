...
import PeiCentral from './components/pei_central'
...
const [entrarPeiCentral, setEntrarPeiCentral] = useState(false)
...
return ( <>
  ...
  <button onClick={() => setEntrarPeiCentral(true)} style={{ marginTop: "20px" }}>
        Pei Central
      </button>
  { /* ------------------------------------------------------ */ }
