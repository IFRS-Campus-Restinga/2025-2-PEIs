# Generated by Django 5.2.5 on 2025-11-19 02:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(max_length=100, validators=[django.core.validators.MinLengthValidator(5), django.core.validators.MaxLengthValidator(100)])),
                ...
                ('aprovado', models.BooleanField(default=False, help_text='Indica se o admin já aprovou o acesso deste usuário.')),
                ('categoria_solicitada', models.CharField(blank=True, help_text='Qual papel o usuário deseja ter (professor, pedagogo, coordenador, admin...).', max_length=50, null=True)),
                ('user', models.OneToOneField(blank=True, help_text='Usuário Django criado após aprovação.', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
