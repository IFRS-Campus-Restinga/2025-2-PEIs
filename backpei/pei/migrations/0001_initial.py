...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(max_length=100, validators=[django.core.validators.MinLengthValidator(7), django.core.validators.MaxLengthValidator(60), django.core.validators.RegexValidator(message='Não use caracteres especiais. Use apenas letras, números e espaços.', regex='^[\\w\\sÀ-ÿ]+$'), pei.validators.unique_validator.UniqueValidator(field_name='nome', message="O campo '{field}' com valor '{value}' já existe.", model_name='pei.CoordenadorCurso')])),
            ],
            options={
                'abstract': False,
            },
...
=======
# Generated by Django 5.2.5 on 2025-11-17 00:52
