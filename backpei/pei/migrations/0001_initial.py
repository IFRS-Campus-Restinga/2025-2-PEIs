# Generated by Django 5.2.6 on 2025-11-19 14:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(validators=[django.core.validators.MinLengthValidator(10), django.core.validators.MaxLengthValidator(100)])),
                ...
                ('categoria', models.CharField(choices=[('ADMIN', 'Administrador do Sistema'), ('NAPNE', 'NAPNE'), ('PROFESSOR', 'Professor'), ('COORDENADOR', 'Coordenador'), ('PEDAGOGO', 'Pedagogo')], default='PROFESSOR', max_length=100)),
