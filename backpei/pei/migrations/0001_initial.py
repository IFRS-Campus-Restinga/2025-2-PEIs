    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome', models.CharField(max_length=100, unique=True, validators=[django.core.validators.MinLengthValidator(7), django.core.validators.MaxLengthValidator(60), django.core.validators.RegexValidator(message='Não use caracteres especiais. Use apenas letras, números e espaços.', regex='^[\\w\\sÀ-ÿ]+$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('ADMIN', 'Administrador do Sistema'), ('NAPNE', 'NAPNE'), ('PROFESSOR', 'Professor'), ('COORDENADOR', 'Coordenador'), ('PEDAGOGO', 'Pedagogo'), ('ALUNO', 'Aluno')], default='PROFESSOR', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aluno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='acompanhamentos', to='pei.aluno')),
            ],
        ),
        migrations.CreateModel(
            name='Curso',
        ...
        migrations.AddField(
            model_name='aluno',
            name='curso',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='aluno', to='pei.curso'),
        ),
        migrations.CreateModel(
            name='Disciplina',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(max_length=100, validators=[django.core.validators.MinLengthValidator(1), django.core.validators.RegexValidator(message='Não use caracteres especiais. Use apenas letras, números e espaços.', regex='^[\\w\\sÀ-ÿ]+$')])),
                ('professores', models.ManyToManyField(limit_choices_to={'groups__name': 'Professor'}, related_name='disciplinas', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='curso',
            name='disciplinas',
            field=models.ManyToManyField(blank=True, related_name='cursos', to='pei.disciplina'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='notificacoes', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aluno', models.ForeignKey(help_text='Aluno ao qual este parecer pertence', on_delete=django.db.models.deletion.CASCADE, related_name='pareceres', to='pei.aluno')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periodo_principal', models.CharField(blank=True, editable=False, max_length=10, null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='componentes_curriculares', to='pei.peiperiodoletivo'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='perfil_usuario', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
